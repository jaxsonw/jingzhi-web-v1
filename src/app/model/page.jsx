    ...
    <div className="flex flex-col justify-between relative group shadow-xs cursor-pointer transition duration-150 ease-out hover:bg-gradient-to-b hover:from-[#ffd085] hover:to-[#FFFFFF] shadow-indigo-500/40 px-[20px] pt-[20px] pb-[14px] border-solid bg-[#fff] rounded-[12px] h-full text-[#000]">
      ...
      {props.typeId === 1 && <div className="flex items-center pb-[18px]">
        <div>
          <div className="flex items-end">
            ...
            <span className="flex mb-[2px] ml-[4px] w-[34px] justify-center bg-[#eaefff] rounded-[2px] text-[12px] text-[#3162FF] items-center border border-[#3162FF] border-solid">
              输入
            </span>
          </div>
        ...
        <div className="ml-[24px]">
          <div className="flex items-end">
            ...
            <span className="flex mb-[2px] ml-[4px] w-[34px] justify-center bg-[#feeded] rounded-[2px] text-[12px] text-[#F24B42] items-center border border-[#F24B42] border-solid">
              输出
            </span>
          </div>
          <span className="text-[12px] text-[#140E35]">/ 百万tokens</span>
      ...
      <div className="btn transition duration-150 ease-out hidden group-hover:flex items-center justify-between">
        ...
        {props.typeId === 1 && <a className="text-[#fff] ml-[12px] flex-1 transition duration-150 ease-out hover:opacity-65 hover:text-white py-[10px] rounded-[8px] flex items-center justify-center bg-[#FF5005]"
          href={process.env.NEXT_PUBLIC_OTHER_USE === "wuhan" ? PLAY_GROUND_URL + `?model=${props?.modelName}&modelType=message` : `/modelplaza/chat/?model=${props?.modelName}`}>
          立即体验
        </a>}
      </div>
    </div>
