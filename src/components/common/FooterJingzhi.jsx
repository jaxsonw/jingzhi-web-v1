                    ...
                    <div className="flex justify-between md:flex-wrap md:gap-[16px]">
                        <div className="flex flex-col gap-[16px] md:gap-[8px]">
                            {process.env.NEXT_PUBLIC_OTHER_USE !== "wuhan" ? <>
                                ...
                                <div className="text-[16px] font-[300] leading-[24px] opacity-60 w-[320px]">
                        ...
                        <div className="flex gap-[32px] justify-end">
                            <div className="flex md:basis-1/3 flex-col gap-[16px]">
                                ...
                                <div className="flex flex-col gap-[12px]">
                                    <Link href="#0" className="text-white inline-block text-[16px] font-[500] leading-[24px] text-[#223B99]">公众号</Link>
                                </div>
                            </div>
                            <div className="flex md:basis-1/3 flex-col gap-[16px]">
                                <div className="text-[14px] font-[500] leading-[20px] opacity-60">联系我们</div>
                                <div className="flex flex-col gap-[12px]">
                                    <Link href="#0" className="text-white inline-block text-[16px] font-[500] leading-[24px] text-[#223B99]">邮箱</Link>
                                </div>
                            </div>
                            <div className="flex md:basis-1/3 flex-col gap-[16px]">
