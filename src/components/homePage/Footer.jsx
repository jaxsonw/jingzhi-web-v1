      ...
      <div className="relative bg-[#F2F8FF] h-screen p-4 w-full">
        ...
        <div className="absolute w-[33%] z-1  top-[9.2rem] left-1/2 -translate-x-[124%]  flex items-end ">
          <motion.div
            ...
            className="box  shrink-0 pl-0  px-6 py-2 text-gray-900 pb-[27px] font-bold text-xl"
          >
            我们的优势
          </motion.div>
          <div className="w-full absolute bottom-0">
            <motion.div
              className="box h-[2px] w-[30%] bg-[#3162FF]"
              initial={{ x: '-100%' }}
              whileInView={{ x: '0%' }}
              transition={{ duration: 1, delay: 0, type: 'spring' }}
            />
            <motion.div
              className="box h-[1px] absolute bottom-[1px] right-0 w-[70%] bg-[#98E2FF]"
              initial={{ x: '-100%' }}
              whileInView={{ x: '0%' }}
              transition={{ duration: 1, delay: 0, type: 'spring' }}
            />
        ...
        <div className="absolute w-[33%] z-1  top-[9.2rem] right-1/2 translate-x-[124%]  flex  flex-row-reverse items-end ">
          <motion.div
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 4, delay: 0, type: 'spring' }}
            className="box  shrink-0 text-right px-6 py-2  pr-0 text-gray-900 pb-[27px] font-bold text-xl"
          >
            AGICTO的愿景
          </motion.div>
          <div className="w-full absolute bottom-0">
            <motion.div
              className="box h-[1px] absolute bottom-[1px] w-[70%] bg-[#98E2FF]"
              initial={{ x: '100%' }}
              whileInView={{ x: '0%' }}
              transition={{ duration: 1, delay: 0, type: 'spring' }}
            />
            <motion.div
              className="box h-[2px] absolute right-0  bottom-0 w-[30%] bg-[#3162FF]"
              initial={{ x: '100%' }}
              whileInView={{ x: '0%' }}
              transition={{ duration: 1, delay: 0, type: 'spring' }}
            />
