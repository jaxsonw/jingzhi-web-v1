    ...
    return (
        <>
                ...
                <div className="mx-auto max-w-2xl lg:max-w-4xl">
                    ...
                    <figure className="mt-10">
                        <blockquote className="text-center text-xl font-semibold leading-8 text-indigo-600 sm:text-2xl sm:leading-9">
                            <p>
                                “为全球用户提供灵活、高效且创新的人工智能解决方案，帮助他们实现更好的工作效率、更高的决策准确性和更大的业务成功。”
                            </p>
                        </blockquote>
            ...
            <footer className="bg-white">
                <div className="max-w-7xl border-t border-gray-200 mx-auto py-6 px-4 overflow-hidden sm:px-6 lg:px-8">

                    <div className="flex items-center justify-between flex-wrap">
                        <p className="w-full mt-8 flex flex-col text-center   justift-end text-gray-400 md:mt-0 md:order-1">
                            <span>2024  AGICTO & AI终极智能枢纽</span>
                            <a href="https://beian.miit.gov.cn" className="underline mt-2">冀ICP备2023005620号-4</a>
                            <span className="mt-4">                            官方联系微信：starkwang_
                            </span>
                        </p>
