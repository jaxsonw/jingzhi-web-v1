    ...
    return (
        <>
            ...
            <div className="relative flex max-w-8xl   sm:px-2 lg:px-8 xl:px-12">
                ...
                <div className='h-[calc(100vh_-_82px)] grow overflow-y-auto  px-10 py-10'>
                    {children}
                </div>
            </div>
        </>
